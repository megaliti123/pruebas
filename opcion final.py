...
def registrar_cancion():
	...
	global pantalla2
	pantalla2.geometry("1100x350+200+200")
	...
	Label(pantalla2,text="fecha de salida	ejemplo: anio-mes-dia")
...
def insertarcancion():
    ...
    sql = "INSERT INTO cancion  VALUES ('{}','{}','{}','{}','{}','{}')".format(titulo_entry.get(),creador_entry.get(),genero_entry.get(),explicitud_entry.get(),fechasalida_entry.get())
...
def eliminar():
    ...
    SQL = "TRUNCATE TABLE cancion WHERE id_cancion=?"
